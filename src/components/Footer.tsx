            ...
            <div className="w-full max-w-[85vw] mx-auto flex flex-col flex-grow justify-between">
                ...
                <div className="flex flex-col lg:flex-row justify-between gap-12 lg:gap-24 flex-grow">
                    ...
                    <div className="lg:w-1/2 flex flex-col gap-10 py-6 lg:py-12">
                        ...
                        {/* Email */}
                        <div className="text-sm md:text-base font-medium opacity-80 lg:mt-auto">
                            <Link href="mailto:ludoralearning@gmail.com" className="font-bold hover:underline opacity-100">
                ...
                <div className="flex flex-col md:flex-row justify-between items-center text-sm font-semibold border-t border-white/20 pt-6 mt-8">
                    ...
                    <div className="flex items-center gap-5 mt-4 md:mt-0">
                        {/* Instagram */}
                        <Link href="https://instagram.com/ludoralearning" target="_blank" className="hover:opacity-60 transition-opacity" aria-label="Instagram">
                        ...
                        {/* YouTube */}
                        <Link href="https://youtube.com/@ludoralearning" target="_blank" className="hover:opacity-60 transition-opacity" aria-label="YouTube">
                            <svg viewBox="0 0 24 24" className="w-5 h-5 fill-white">
                                <path d="M23.498 6.186a3.016 3.016 0 00-2.122-2.136C19.505 3.545 12 3.545 12 3.545s-7.505 0-9.377.505A3.017 3.017 0 00.502 6.186C0 8.07 0 12 0 12s0 3.93.502 5.814a3.016 3.016 0 002.122 2.136c1.871.505 9.376.505 9.376.505s7.505 0 9.377-.505a3.015 3.015 0 002.122-2.136C24 15.93 24 12 24 12s0-3.93-.502-5.814zM9.545 15.568V8.432L15.818 12l-6.273 3.568z" />
                            </svg>
                        </Link>
                        {/* Discord */}
                        <Link href="https://discord.gg/6SzMn3EqsV" target="_blank" className="hover:opacity-60 transition-opacity" aria-label="Discord">
                            <svg viewBox="0 0 24 24" className="w-5 h-5 fill-white">
                        ...
                        {/* TikTok */}
                        <Link href="https://tiktok.com/@ludora.learning" target="_blank" className="hover:opacity-60 transition-opacity" aria-label="TikTok">
                            <svg viewBox="0 0 24 24" className="w-5 h-5 fill-white">
                                <path d="M12.525.02c1.31-.02 2.61-.01 3.91-.02.08 1.53.63 3.09 1.75 4.17 1.12 1.11 2.7 1.62 4.24 1.79v4.03c-1.44-.05-2.89-.35-4.2-.97-.57-.26-1.1-.59-1.62-.93-.01 2.92.01 5.84-.02 8.75-.08 1.4-.54 2.79-1.35 3.94-1.31 1.92-3.58 3.17-5.91 3.21-1.43.08-2.86-.31-4.08-1.03-2.02-1.19-3.44-3.37-3.65-5.71-.02-.5-.03-1-.01-1.49.18-1.9 1.12-3.72 2.58-4.96 1.66-1.44 3.98-2.13 6.15-1.72.02 1.48-.04 2.96-.04 4.44-.99-.32-2.15-.23-3.02.37-.63.41-1.11 1.04-1.36 1.75-.21.51-.15 1.07-.14 1.61.24 1.64 1.82 3.02 3.5 2.87 1.12-.01 2.19-.66 2.77-1.61.19-.33.4-.67.41-1.06.1-1.79.06-3.57.07-5.36.01-4.03-.01-8.05.02-12.07z" />
                            </svg>
                        </Link>
                        {/* WhatsApp */}
                        <Link href="https://wa.me/message" target="_blank" className="hover:opacity-60 transition-opacity" aria-label="WhatsApp">
                            <svg viewBox="0 0 24 24" className="w-5 h-5 fill-white">
