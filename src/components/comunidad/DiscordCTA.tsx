...
export default function DiscordCTA() {
    ...
    return (
        <section className="relative w-full bg-[#1a1a2e] rounded-[50px] overflow-hidden shadow-[0_30px_100px_rgb(88,101,242,0.15)]">

            {/* ── Mobile: content overlaid on portal gif ── */}
            <div className="block lg:hidden relative min-h-screen overflow-hidden">
                {/* Portal gif as full background */}
                <div
                ...
                >
                    ...
                    <motion.div variants={itemVariants}>
                        <a
                            ...
                            className="group inline-flex items-center gap-3 bg-[#5865F2] text-white px-8 py-4 rounded-[20px] font-black text-lg tracking-wide shadow-[0_10px_30px_0_rgba(88,101,242,0.4)] active:translate-y-1 transition-all duration-300 w-full justify-center"
                        >
            ...
            <div className="hidden lg:flex items-center min-h-screen px-6 py-32">
                <div className="relative z-10 max-w-7xl mx-auto w-full grid grid-cols-2 gap-20 items-center">
                    ...
                    >
                        <motion.div variants={itemVariants} className="flex flex-col gap-6">
                            ...
                            <h2 className="text-5xl lg:text-7xl font-black text-white tracking-tight leading-[1.05]">
                                Entra a la <br />
                                <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#5865F2] to-[#9ba2ff]">fortaleza</span>
                            </h2>
                        </motion.div>
                    ...
                    <motion.div
                        ...
                        className="relative aspect-[3/4] max-w-md mx-auto w-full rounded-[40px] overflow-hidden shadow-2xl border border-[#5865F2]/30 group"
                    >
                        <div
