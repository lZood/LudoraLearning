                ...
                >
                    <motion.div variants={itemVariants} className="flex items-center gap-6">
                        ...
                        <h2 className="text-4xl md:text-5xl lg:text-6xl font-black text-[#222222] tracking-tight leading-[1.1]">
                            Uso Real <br />
                            <span className="text-[#d97706]">del Idioma</span>
                        </h2>
                    </motion.div>

                    <div className="flex flex-col gap-6 max-w-xl">
                        <motion.p variants={itemVariants} className="text-xl md:text-2xl text-[#444444] font-medium leading-relaxed">
                            En Ludora, aprender un idioma significa <strong className="text-[#d97706]">saber usarlo</strong>. Fomentamos la comunicación constante: desde niveles básicos hasta la inmersión total.
                        </motion.p>
