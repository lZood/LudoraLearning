...
export const questionBank: Question[] = [
    ...
    { id: 'a1-ext-5', skillId: 'A1-ORAL-NUMBERS', level: 'A1', category: 'Producción Oral', type: 'audio-record', text: 'Tienes 5 bloques. Di en inglés "Tengo cinco bloques" ("I have five blocks").', gradingRubric: 'Pronunciación de "I have five blocks".' },
    ...
    { id: 'a1-alto-ext-3', skillId: 'A1ALTO-WRITTEN-NEED', level: 'A1-alto', category: 'Producción Escrita', type: 'text-input', text: 'Escribe en el chat que "necesitas comida" (need food)', gradingRubric: 'El alumno pide comida usando "need food" o "I am hungry".' },
    ...
    { id: 'a1-alto-ext-5', skillId: 'A1ALTO-ORAL-WHERE', level: 'A1-alto', category: 'Producción Oral', type: 'audio-record', text: 'Pregúntale en voz alta a un amigo "¿Dónde estás?" ("Where are you?").', gradingRubric: 'Hacer la pregunta de ubicación en inglés simple.' },
