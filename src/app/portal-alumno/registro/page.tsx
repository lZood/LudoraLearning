                ...
                <div className="bg-white rounded-3xl p-8 shadow-2xl shadow-[#361A27]/50 border-t-4 border-[#0F5451]">
                    ...
                    <div className="mt-6 flex flex-col items-center gap-3 text-sm text-center">
                        <p className="text-gray-500 text-xs px-2">
                            Al crear una cuenta, aceptas nuestros <Link href="#" className="text-[#0F5451] hover:underline">Términos de servicio</Link> y <Link href="#" className="text-[#0F5451] hover:underline">Política de privacidad</Link>.
                        </p>
                        <div className="text-gray-500 mt-2">
                            ¿Ya tienes cuenta? <Link href="/portal-alumno" className="text-[#0F5451] font-bold hover:text-[#0F7357] hover:underline transition-colors">Inicia sesión</Link>
                        </div>
                    </div>
