            ...
            <div className="flex items-center justify-between">
                <div>
                    ...
                    <h1 className="text-3xl font-extrabold text-gray-900">
                        Comenzando con Inglés Básico
                    </h1>
                    <p className="mt-2 text-gray-600 max-w-3xl">
                        Descubre los conceptos básicos del idioma inglés, incluyendo vocabularios clave, gramática esencial y conversaciones diarias.
                    </p>
                </div>
                ...
                <div className="flex flex-col gap-6">
                    ...
                    <div className="bg-white border-2 border-gray-100 rounded-3xl p-6 shadow-sm flex flex-col items-center justify-center text-center">
                        <div className="w-24 h-24 mb-4 relative">
                            <img src="/images/certificate.png" alt="Certificate" className="opacity-80" onError={(e) => { e.currentTarget.style.display = 'none'; }} />
